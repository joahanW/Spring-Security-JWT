...
import com.springsecurity.jwt.model.dto.AddRoleRequest;
    ...
    public void refreshToken(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer " )) {
            try {
                ...
                Algorithm algorithm = Algorithm.HMAC256("screat".getBytes());
                ...
                String access_token = JWT.create()
                        ...
                        .withExpiresAt(new Date(System.currentTimeMillis() + 5 * 60 *1000)) // 10 Menit
                ...
                log.error("Error logging in: {}", exeption.getMessage());
                response.setHeader("error", exeption.getMessage());
                response.setStatus(FORBIDDEN.value());
                Map<String, String> error = new HashMap<>();
                error.put("error_message",exeption.getMessage());
                response.setContentType(APPLICATION_JSON_VALUE);
